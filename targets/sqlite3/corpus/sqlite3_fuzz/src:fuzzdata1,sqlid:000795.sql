CREATE TABLE c1(x INTEGER PRIMARY KEY CONSTRAINT p1);
...
CREATE TABLE c04(x TEXT COLLATE nocase references p4);
...
FOREIGN KEY(x,y) REFERENCES p5(c,b));ANALYZE TABLE ocase, y TEX(x,y) REFERENCES p6(c,b));
