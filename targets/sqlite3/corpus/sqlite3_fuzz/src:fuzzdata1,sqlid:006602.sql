...
INSERT INTO t1 VALUES(60, 1,X'0000');
INSERT INTO t1 VALUES(70, 1,X'0000');
INSERT INTO t1 VALUES(80, 1,X'');
INSERT INTO t1 VALUES(90, 1, 'o0000');
INSERT INTO t1 SELECT a+1,2,'000' || substr(c, -14) FROM t1;
INSERT INTO t1 SELECT a+2,3,'0'||substr(c,0, -14) FROM t1;
INNSE