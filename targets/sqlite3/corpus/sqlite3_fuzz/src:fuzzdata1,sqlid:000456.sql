...
CREATE TEMP TABLE TempT000e(Te0tID char(1) PRIMARY KEY, Te0tSt00n0 TEXT);
...
UPDATE TempT000e SET Te0tSt00n0 = Te0tSt00n0 + 0 WHERE Te0tID<9 OR Te0tId<2;
CELECT Te0tSt00n0 FROM Re00T000e ORDER BY 1;
